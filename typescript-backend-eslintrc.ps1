...
npm i -D eslint eslint-config-standard prettier eslint-config-prettier eslint-plugin-deprecation eslint-plugin-prettier@alpha eslint-plugin-sonarjs @typescript-eslint/parser @typescript-eslint/eslint-plugin
