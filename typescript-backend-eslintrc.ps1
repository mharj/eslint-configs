...
npm i -D eslint@8 eslint-config-standard prettier eslint-config-prettier eslint-plugin-deprecation eslint-plugin-prettier eslint-plugin-sonarjs@0.23 @typescript-eslint/parser @typescript-eslint/eslint-plugin @stylistic/eslint-plugin
